// V17.1.2-p8f5c — role-based landing + minimal router (uses @ alias; no ROUTES)
...
function Guarded(props: { element: React.ReactElement; roles?: Role[] }) {
      ...
      <AppShell version={VERSION}>
        <React.Suspense fallback={<div className="p-4">Loading…</div>}>
          <Routes>
            ...
            <Route
              path="/products"
              element={<Guarded roles={['Admin','Finance','Operations','CustomerService']} element={<ProductsView />} />}
            />
            <Route
              path="/products/:id"
              element={<Guarded roles={['Admin','Finance','Operations','CustomerService']} element={<ProductDetail />} />}
            />
            <Route
              path="*"
              element={
